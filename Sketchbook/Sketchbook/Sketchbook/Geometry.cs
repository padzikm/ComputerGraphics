...
namespace Sketchbook
{
    class Geometry
    {
        ...
        public struct Triangle
        {
            ...
            public Triangle(Point pa, Point pb, Point pc) { a = pa; b = pb; c = pc; }
            ...
            public static bool operator ==(Triangle t1, Triangle t2)
            {
                ...
                if (t1.a == t2.a)
                {
                    ...
                    if (t1.b == t2.c && t1.c == t2.b) return true;
                }
                else
                    if (t1.a == t2.b)
                    {
                        if (t1.b == t2.a && t1.c == t2.c) return true;
                        if (t1.b == t2.c && t1.c == t2.a) return true;
                    }
                    else
                        if (t1.a == t2.c)
                        {
                            if (t1.b == t2.a && t1.c == t2.b) return true;
                            if (t1.b == t2.b && t1.c == t2.a) return true;
                        }
